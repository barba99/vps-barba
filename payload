...
echo -e "${cor[5]} Payload Brute Force @Jorge_Barba"
...
while true; do
echo -e " [1]-Test Un Payload"
echo -e " [2]-Test Payloads Creadas"
echo -e "${cor[1]} $bar ${cor[0]}"
read -p " [1-2]: " opx
case $opx in
1)
read -p " Escriba su Payload: " payloadx
read -p " Escriba su Proxy: " hostprox
read -p " Escriba su Puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
...
echo -ne "\033[1;31mStatus\033[1;32m\n"
